...
export default function FloatingWhatsapp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-eco text-white shadow-[0_12px_32px_rgba(20,20,20,0.14)] transition hover:bg-eco-dark"
    >
